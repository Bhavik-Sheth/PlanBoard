...
def resolve_relative_path(planner_path: Path | str, filename: str) -> str | None:
    ...
    # 5. Fallback: search recursively for the first matching filename in the planner directory
    try:
