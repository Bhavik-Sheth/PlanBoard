"""
module_planboard_agent.py — Module spec planboard agent.
Reads: all PLANBOARD/*.md files (StructuredIdea, TRD, Schema, Rules, Constraints)
...
from planboard.agents._base import load_context, invoke_llm_safe, strip_markdown_fence, get_update_instructions
...
def _gather(state: PlannerState) -> PlannerState:
    ...
    # Check if other PLANBOARD files exist
...
def module_planboard_agent(state: PlannerState) -> PlannerState:
