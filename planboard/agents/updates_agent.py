"""
planboard/agents/updates_agent.py
...
from planboard.agents._base import invoke_llm_safe, strip_markdown_fence
from planboard.tools.validation_tools import check_frontend_signals
...
6. A list of 1 to 3 direct clarifying questions in ambiguous_parts if confidence is not 'high'."""
        ...
        existing_files = [f.name for f in self.planboard_dir.glob("*.md") if f.is_file()]
