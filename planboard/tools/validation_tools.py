"""
planboard/tools/validation_tools.py — File validation and consistency check tools.
"""

import os
import re
from planboard.tools.file_tools import read_file
from planboard.tools.llm_tools import llm_call_json
...
def check_consistency(files: dict[str, str]) -> list[dict]:
    ...
    Takes {filename: content} dict of all PLANBOARD/ files.
