"""
planboard/tools/tracker_tools.py — Tracker.md manipulation tools.
"""
...
from planboard.tools.exceptions import InvalidStatusError
from planboard.tools.file_tools import read_file, write_file
...
TRACKED_FILES = [
    ...
    ("ARCHITECTURE_DIAGRAMS/SystemDesign.md",       "system_design_agent"),
    ("ARCHITECTURE_DIAGRAMS/SystemArchitecture.md", "system_architecture_agent"),
    ("ARCHITECTURE_DIAGRAMS/FolderStructure.md",    "folder_structure_agent"),
    ("ARCHITECTURE_DIAGRAMS/DataFlow.md",           "data_flow_agent"),
    ("Rules.md",             "rules_agent"),
    ("ImplementationPlan.md","implementation_agent"),
    ("MODULES/",             "module_planboard_agent"),
]
...
def read_tracker(project_path: str) -> dict:
    ...
    """
    tracker_path = os.path.join(project_path, "PLANBOARD", "Tracker.md")
